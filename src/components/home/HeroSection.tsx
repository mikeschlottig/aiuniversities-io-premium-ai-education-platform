...
export function HeroSection() {
  ...
  return (
    <section className="relative py-24 md:py-40 overflow-hidden bg-slate-950">
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none animate-gradient-x bg-gradient-to-br from-blue-900/20 via-slate-950 to-violet-900/20 bg-[length:200%_200%]" />
      ...
      <div className="relative z-10 text-center space-y-10 max-w-5xl mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900/80 border border-white/10 text-slate-300 text-sm font-medium mb-8 backdrop-blur-sm shadow-lg shadow-blue-500/5">
          ...
          <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-white leading-[1.05] mb-8">
            Master the <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-violet-500 animate-gradient-x bg-[length:200%_auto]">
              AI Frontier
            </span>
          </h1>
        ...
        >
          <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-10 h-16 text-xl rounded-2xl group shadow-xl shadow-blue-500/20 transition-all hover:scale-105 hover:shadow-blue-500/40 active:scale-95 will-change-transform">
            Start Learning Free
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: partnersLoaded ? 1 : 0 }}
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20">
            {['MIT', 'STANFORD', 'ANTHROPIC', 'OPENAI', 'DEEPMIND'].map((partner, i) => (
              <motion.span
                key={partner}
                ...
                className="text-2xl font-bold text-white tracking-tighter grayscale transition-all duration-300 cursor-default"
              >
                {partner}
              </motion.span>
            ))}
