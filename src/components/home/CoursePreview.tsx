    ...
    <section className="py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {SITE_DATA.featuredCourses.map((course, idx) => (
          ...
          >
            <Card
              className="bg-slate-900/40 border-white/10 overflow-hidden group hover:border-blue-500/40 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:scale-[1.03] flex flex-col h-full relative"
            >
              {/* Shine Effect */}
              <div className="absolute inset-0 pointer-events-none overflow-hidden z-20">
                <div className="absolute -inset-[100%] bg-gradient-to-r from-transparent via-white/5 to-transparent skew-x-12 -translate-x-full group-hover:animate-[shimmer_1.5s_ease-in-out]" />
              </div>
