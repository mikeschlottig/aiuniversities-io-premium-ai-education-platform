          ...
          <section key={section.id} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {section.items.map((item, idx) => (
                <Card key={idx} className="bg-slate-900/40 border-white/10 hover:bg-slate-900/60 transition-colors">
                  ...
                  <CardContent>
                    <Button variant="link" className="p-0 h-auto text-blue-400 hover:text-blue-300 text-sm font-medium group">
                      Learn More
